        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              ...
              {formatNumber(summary.unpaidOrdersCount)} awaiting payment.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              ...
              {formatNumber(summary.processingOrdersCount)} in progress.
            </p>
          </CardContent>
        </Card>
      </div>
        ...
        <Card className="xl:col-span-7">
          <CardHeader className="flex flex-row items-center justify-between gap-4">
            <div>
              ...
              <CardDescription>
                Latest transactions with payment and delivery status.
              </CardDescription>
            </div>
                  ...
                  <TableRow key={order.id}>
                    ...
                    <TableCell>
                      <div className="flex flex-wrap gap-2">
                        ...
                        <Badge
                          variant={order.isDelivered ? "secondary" : "outline"}>
