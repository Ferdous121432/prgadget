        ...
        <div className="col-span-2 space-4-y overlow-x-auto">
          <Card>
            <CardContent className="p-4 gap-4">
              ...
              {isPaid ? (
                <Badge variant="secondary" className="button-primary">
                  Paid at {formatDateTime(paidAt!).dateTime}
                </Badge>
              ) : (
                <Badge className="destructive-button ">Not paid</Badge>
              )}
            </CardContent>
          </Card>
          <Card className="my-2">
            <CardContent className="p-4 gap-4">
              ...
              {isDelivered ? (
                ...
                <Badge variant="destructive" className="destructive-button">
                  Not Delivered
                </Badge>
              )}
            </CardContent>
